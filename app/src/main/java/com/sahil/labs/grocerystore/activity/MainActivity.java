package com.sahil.labs.grocerystore.activity;
...
import com.sahil.labs.grocerystore.fragment.CategoryFragment;
import com.sahil.labs.grocerystore.fragment.HomeFragment;
import com.sahil.labs.grocerystore.fragment.MyOrderFragment;
import com.sahil.labs.grocerystore.fragment.NewProductFragment;
import com.sahil.labs.grocerystore.fragment.OffrersFragment;
import com.sahil.labs.grocerystore.fragment.PopularProductFragment;
import com.sahil.labs.grocerystore.fragment.ProfileFragment;
import com.sahil.labs.grocerystore.helper.Converter;
import com.sahil.labs.grocerystore.model.User;
import com.sahil.labs.grocerystore.util.localstorage.GroceryDatabase;
import com.sahil.labs.grocerystore.util.localstorage.LocalStorage;
...
public class MainActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db=new GroceryDatabase(getApplicationContext());
        ...
        nav_footer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String Cart=localStorage.getCart();
                localStorage.logoutUser();
                //Log.i("mytag",Cart);
                db.Update(user.getEmail(),Cart);
